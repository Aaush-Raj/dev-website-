...
/**
 * COMING SOON — the 404 page's body
 * ---------------------------------------------------------------------------
 ...
 *
 * WHY THIS IS A COMPONENT AND NOT THE PAGE ITSELF
 * It is rendered from TWO not-found files — see app/not-found.tsx for why
 * there have to be two — and this is the one place the copy lives.
 */
